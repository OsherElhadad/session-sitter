...
// Compiled from src/BobDatabase.ts by scripts/build-plugin-lib.js (`make plugin`).
// Edit the TypeScript source and re-run `make plugin`; CI fails if this tree is stale.
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.execPython3 = execPython3;
exports.queryBobDb = queryBobDb;
...
function execPython3(args, maxBuffer = 32 * 1024 * 1024) {
    return new Promise((resolve, reject) => {
        (0, child_process_1.execFile)('python3', args, { maxBuffer }, (err, stdout, stderr) => {
            if (err) {
 ...
 */
async function queryBobDb(dbPath, sql, params = []) {
    const out = await execPython3(['-c', QUERY_SCRIPT, dbPath, sql, ...params.map(p => String(p))]);
