...
inkscape -w 1440 --export-type=png --export-filename=lockup-light.png   lockup-light.svg
inkscape -w 1440 --export-type=png --export-filename=lockup-dark.png    lockup-dark.svg
inkscape -w 1280 --export-type=png --export-filename=social-preview.png social-preview.svg

# The marketplace icon must live outside docs/ — see .vscodeignore.
cp logo-256.png ../../resources/logo.png

echo "regenerated every PNG in this folder from its SVG source"
